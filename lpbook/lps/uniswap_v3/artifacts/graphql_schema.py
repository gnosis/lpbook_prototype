...
class Bundle_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'eth_price_usd', 'eth_price_usd_not', 'eth_price_usd_gt', 'eth_price_usd_lt', 'eth_price_usd_gte', 'eth_price_usd_lte', 'eth_price_usd_in', 'eth_price_usd_not_in', '_change_block')
...
class Flash_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'transaction', 'transaction_not', 'transaction_gt', 'transaction_lt', 'transaction_gte', 'transaction_lte', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_contains_nocase', 'transaction_not_contains', 'transaction_not_contains_nocase', 'transaction_starts_with', 'transaction_starts_with_nocase', 'transaction_not_starts_with', 'transaction_not_starts_with_nocase', 'transaction_ends_with', 'transaction_ends_with_nocase', 'transaction_not_ends_with', 'transaction_not_ends_with_nocase', 'transaction_', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_contains_nocase', 'pool_not_contains', 'pool_not_contains_nocase', 'pool_starts_with', 'pool_starts_with_nocase', 'pool_not_starts_with', 'pool_not_starts_with_nocase', 'pool_ends_with', 'pool_ends_with_nocase', 'pool_not_ends_with', 'pool_not_ends_with_nocase', 'pool_', 'sender', 'sender_not', 'sender_in', 'sender_not_in', 'sender_contains', 'sender_not_contains', 'recipient', 'recipient_not', 'recipient_in', 'recipient_not_in', 'recipient_contains', 'recipient_not_contains', 'amount0', 'amount0_not', 'amount0_gt', 'amount0_lt', 'amount0_gte', 'amount0_lte', 'amount0_in', 'amount0_not_in', 'amount1', 'amount1_not', 'amount1_gt', 'amount1_lt', 'amount1_gte', 'amount1_lte', 'amount1_in', 'amount1_not_in', 'amount_usd', 'amount_usd_not', 'amount_usd_gt', 'amount_usd_lt', 'amount_usd_gte', 'amount_usd_lte', 'amount_usd_in', 'amount_usd_not_in', 'amount0_paid', 'amount0_paid_not', 'amount0_paid_gt', 'amount0_paid_lt', 'amount0_paid_gte', 'amount0_paid_lte', 'amount0_paid_in', 'amount0_paid_not_in', 'amount1_paid', 'amount1_paid_not', 'amount1_paid_gt', 'amount1_paid_lt', 'amount1_paid_gte', 'amount1_paid_lte', 'amount1_paid_in', 'amount1_paid_not_in', 'log_index', 'log_index_not', 'log_index_gt', 'log_index_lt', 'log_index_gte', 'log_index_lte', 'log_index_in', 'log_index_not_in', '_change_block')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class Pool_filter(sgqlc.types.Input):
    ...
    collects_ = sgqlc.types.Field(Collect_filter, graphql_name='collects_')
...
class Position_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'owner', 'owner_not', 'owner_in', 'owner_not_in', 'owner_contains', 'owner_not_contains', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_contains_nocase', 'pool_not_contains', 'pool_not_contains_nocase', 'pool_starts_with', 'pool_starts_with_nocase', 'pool_not_starts_with', 'pool_not_starts_with_nocase', 'pool_ends_with', 'pool_ends_with_nocase', 'pool_not_ends_with', 'pool_not_ends_with_nocase', 'pool_', 'token0', 'token0_not', 'token0_gt', 'token0_lt', 'token0_gte', 'token0_lte', 'token0_in', 'token0_not_in', 'token0_contains', 'token0_contains_nocase', 'token0_not_contains', 'token0_not_contains_nocase', 'token0_starts_with', 'token0_starts_with_nocase', 'token0_not_starts_with', 'token0_not_starts_with_nocase', 'token0_ends_with', 'token0_ends_with_nocase', 'token0_not_ends_with', 'token0_not_ends_with_nocase', 'token0_', 'token1', 'token1_not', 'token1_gt', 'token1_lt', 'token1_gte', 'token1_lte', 'token1_in', 'token1_not_in', 'token1_contains', 'token1_contains_nocase', 'token1_not_contains', 'token1_not_contains_nocase', 'token1_starts_with', 'token1_starts_with_nocase', 'token1_not_starts_with', 'token1_not_starts_with_nocase', 'token1_ends_with', 'token1_ends_with_nocase', 'token1_not_ends_with', 'token1_not_ends_with_nocase', 'token1_', 'tick_lower', 'tick_lower_not', 'tick_lower_gt', 'tick_lower_lt', 'tick_lower_gte', 'tick_lower_lte', 'tick_lower_in', 'tick_lower_not_in', 'tick_lower_contains', 'tick_lower_contains_nocase', 'tick_lower_not_contains', 'tick_lower_not_contains_nocase', 'tick_lower_starts_with', 'tick_lower_starts_with_nocase', 'tick_lower_not_starts_with', 'tick_lower_not_starts_with_nocase', 'tick_lower_ends_with', 'tick_lower_ends_with_nocase', 'tick_lower_not_ends_with', 'tick_lower_not_ends_with_nocase', 'tick_lower_', 'tick_upper', 'tick_upper_not', 'tick_upper_gt', 'tick_upper_lt', 'tick_upper_gte', 'tick_upper_lte', 'tick_upper_in', 'tick_upper_not_in', 'tick_upper_contains', 'tick_upper_contains_nocase', 'tick_upper_not_contains', 'tick_upper_not_contains_nocase', 'tick_upper_starts_with', 'tick_upper_starts_with_nocase', 'tick_upper_not_starts_with', 'tick_upper_not_starts_with_nocase', 'tick_upper_ends_with', 'tick_upper_ends_with_nocase', 'tick_upper_not_ends_with', 'tick_upper_not_ends_with_nocase', 'tick_upper_', 'liquidity', 'liquidity_not', 'liquidity_gt', 'liquidity_lt', 'liquidity_gte', 'liquidity_lte', 'liquidity_in', 'liquidity_not_in', 'deposited_token0', 'deposited_token0_not', 'deposited_token0_gt', 'deposited_token0_lt', 'deposited_token0_gte', 'deposited_token0_lte', 'deposited_token0_in', 'deposited_token0_not_in', 'deposited_token1', 'deposited_token1_not', 'deposited_token1_gt', 'deposited_token1_lt', 'deposited_token1_gte', 'deposited_token1_lte', 'deposited_token1_in', 'deposited_token1_not_in', 'withdrawn_token0', 'withdrawn_token0_not', 'withdrawn_token0_gt', 'withdrawn_token0_lt', 'withdrawn_token0_gte', 'withdrawn_token0_lte', 'withdrawn_token0_in', 'withdrawn_token0_not_in', 'withdrawn_token1', 'withdrawn_token1_not', 'withdrawn_token1_gt', 'withdrawn_token1_lt', 'withdrawn_token1_gte', 'withdrawn_token1_lte', 'withdrawn_token1_in', 'withdrawn_token1_not_in', 'collected_fees_token0', 'collected_fees_token0_not', 'collected_fees_token0_gt', 'collected_fees_token0_lt', 'collected_fees_token0_gte', 'collected_fees_token0_lte', 'collected_fees_token0_in', 'collected_fees_token0_not_in', 'collected_fees_token1', 'collected_fees_token1_not', 'collected_fees_token1_gt', 'collected_fees_token1_lt', 'collected_fees_token1_gte', 'collected_fees_token1_lte', 'collected_fees_token1_in', 'collected_fees_token1_not_in', 'transaction', 'transaction_not', 'transaction_gt', 'transaction_lt', 'transaction_gte', 'transaction_lte', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_contains_nocase', 'transaction_not_contains', 'transaction_not_contains_nocase', 'transaction_starts_with', 'transaction_starts_with_nocase', 'transaction_not_starts_with', 'transaction_not_starts_with_nocase', 'transaction_ends_with', 'transaction_ends_with_nocase', 'transaction_not_ends_with', 'transaction_not_ends_with_nocase', 'transaction_', 'fee_growth_inside0_last_x128', 'fee_growth_inside0_last_x128_not', 'fee_growth_inside0_last_x128_gt', 'fee_growth_inside0_last_x128_lt', 'fee_growth_inside0_last_x128_gte', 'fee_growth_inside0_last_x128_lte', 'fee_growth_inside0_last_x128_in', 'fee_growth_inside0_last_x128_not_in', 'fee_growth_inside1_last_x128', 'fee_growth_inside1_last_x128_not', 'fee_growth_inside1_last_x128_gt', 'fee_growth_inside1_last_x128_lt', 'fee_growth_inside1_last_x128_gte', 'fee_growth_inside1_last_x128_lte', 'fee_growth_inside1_last_x128_in', 'fee_growth_inside1_last_x128_not_in', '_change_block')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
    ...
    tick_lower_contains_nocase = sgqlc.types.Field(String, graphql_name='tickLower_contains_nocase')
    tick_lower_not_contains = sgqlc.types.Field(String, graphql_name='tickLower_not_contains')
    tick_lower_not_contains_nocase = sgqlc.types.Field(String, graphql_name='tickLower_not_contains_nocase')
    tick_lower_starts_with = sgqlc.types.Field(String, graphql_name='tickLower_starts_with')
    tick_lower_starts_with_nocase = sgqlc.types.Field(String, graphql_name='tickLower_starts_with_nocase')
    tick_lower_not_starts_with = sgqlc.types.Field(String, graphql_name='tickLower_not_starts_with')
    tick_lower_not_starts_with_nocase = sgqlc.types.Field(String, graphql_name='tickLower_not_starts_with_nocase')
    tick_lower_ends_with = sgqlc.types.Field(String, graphql_name='tickLower_ends_with')
    tick_lower_ends_with_nocase = sgqlc.types.Field(String, graphql_name='tickLower_ends_with_nocase')
    tick_lower_not_ends_with = sgqlc.types.Field(String, graphql_name='tickLower_not_ends_with')
    tick_lower_not_ends_with_nocase = sgqlc.types.Field(String, graphql_name='tickLower_not_ends_with_nocase')
    tick_lower_ = sgqlc.types.Field('Tick_filter', graphql_name='tickLower_')
    ...
    tick_upper_contains_nocase = sgqlc.types.Field(String, graphql_name='tickUpper_contains_nocase')
    tick_upper_not_contains = sgqlc.types.Field(String, graphql_name='tickUpper_not_contains')
    tick_upper_not_contains_nocase = sgqlc.types.Field(String, graphql_name='tickUpper_not_contains_nocase')
    tick_upper_starts_with = sgqlc.types.Field(String, graphql_name='tickUpper_starts_with')
    tick_upper_starts_with_nocase = sgqlc.types.Field(String, graphql_name='tickUpper_starts_with_nocase')
    tick_upper_not_starts_with = sgqlc.types.Field(String, graphql_name='tickUpper_not_starts_with')
    tick_upper_not_starts_with_nocase = sgqlc.types.Field(String, graphql_name='tickUpper_not_starts_with_nocase')
    tick_upper_ends_with = sgqlc.types.Field(String, graphql_name='tickUpper_ends_with')
    tick_upper_ends_with_nocase = sgqlc.types.Field(String, graphql_name='tickUpper_ends_with_nocase')
    tick_upper_not_ends_with = sgqlc.types.Field(String, graphql_name='tickUpper_not_ends_with')
    tick_upper_not_ends_with_nocase = sgqlc.types.Field(String, graphql_name='tickUpper_not_ends_with_nocase')
    tick_upper_ = sgqlc.types.Field('Tick_filter', graphql_name='tickUpper_')
    liquidity = sgqlc.types.Field(BigInt, graphql_name='liquidity')
    liquidity_not = sgqlc.types.Field(BigInt, graphql_name='liquidity_not')
    liquidity_gt = sgqlc.types.Field(BigInt, graphql_name='liquidity_gt')
    liquidity_lt = sgqlc.types.Field(BigInt, graphql_name='liquidity_lt')
...
class TickDayData_filter(sgqlc.types.Input):
    ...
    tick_contains_nocase = sgqlc.types.Field(String, graphql_name='tick_contains_nocase')
    tick_not_contains = sgqlc.types.Field(String, graphql_name='tick_not_contains')
    tick_not_contains_nocase = sgqlc.types.Field(String, graphql_name='tick_not_contains_nocase')
    tick_starts_with = sgqlc.types.Field(String, graphql_name='tick_starts_with')
    tick_starts_with_nocase = sgqlc.types.Field(String, graphql_name='tick_starts_with_nocase')
    tick_not_starts_with = sgqlc.types.Field(String, graphql_name='tick_not_starts_with')
    tick_not_starts_with_nocase = sgqlc.types.Field(String, graphql_name='tick_not_starts_with_nocase')
    tick_ends_with = sgqlc.types.Field(String, graphql_name='tick_ends_with')
    tick_ends_with_nocase = sgqlc.types.Field(String, graphql_name='tick_ends_with_nocase')
    tick_not_ends_with = sgqlc.types.Field(String, graphql_name='tick_not_ends_with')
    tick_not_ends_with_nocase = sgqlc.types.Field(String, graphql_name='tick_not_ends_with_nocase')
    tick_ = sgqlc.types.Field('Tick_filter', graphql_name='tick_')
...
class TickHourData_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'period_start_unix', 'period_start_unix_not', 'period_start_unix_gt', 'period_start_unix_lt', 'period_start_unix_gte', 'period_start_unix_lte', 'period_start_unix_in', 'period_start_unix_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_contains_nocase', 'pool_not_contains', 'pool_not_contains_nocase', 'pool_starts_with', 'pool_starts_with_nocase', 'pool_not_starts_with', 'pool_not_starts_with_nocase', 'pool_ends_with', 'pool_ends_with_nocase', 'pool_not_ends_with', 'pool_not_ends_with_nocase', 'pool_', 'tick', 'tick_not', 'tick_gt', 'tick_lt', 'tick_gte', 'tick_lte', 'tick_in', 'tick_not_in', 'tick_contains', 'tick_contains_nocase', 'tick_not_contains', 'tick_not_contains_nocase', 'tick_starts_with', 'tick_starts_with_nocase', 'tick_not_starts_with', 'tick_not_starts_with_nocase', 'tick_ends_with', 'tick_ends_with_nocase', 'tick_not_ends_with', 'tick_not_ends_with_nocase', 'tick_', 'liquidity_gross', 'liquidity_gross_not', 'liquidity_gross_gt', 'liquidity_gross_lt', 'liquidity_gross_gte', 'liquidity_gross_lte', 'liquidity_gross_in', 'liquidity_gross_not_in', 'liquidity_net', 'liquidity_net_not', 'liquidity_net_gt', 'liquidity_net_lt', 'liquidity_net_gte', 'liquidity_net_lte', 'liquidity_net_in', 'liquidity_net_not_in', 'volume_token0', 'volume_token0_not', 'volume_token0_gt', 'volume_token0_lt', 'volume_token0_gte', 'volume_token0_lte', 'volume_token0_in', 'volume_token0_not_in', 'volume_token1', 'volume_token1_not', 'volume_token1_gt', 'volume_token1_lt', 'volume_token1_gte', 'volume_token1_lte', 'volume_token1_in', 'volume_token1_not_in', 'volume_usd', 'volume_usd_not', 'volume_usd_gt', 'volume_usd_lt', 'volume_usd_gte', 'volume_usd_lte', 'volume_usd_in', 'volume_usd_not_in', 'fees_usd', 'fees_usd_not', 'fees_usd_gt', 'fees_usd_lt', 'fees_usd_gte', 'fees_usd_lte', 'fees_usd_in', 'fees_usd_not_in', '_change_block')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class Transaction_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'block_number', 'block_number_not', 'block_number_gt', 'block_number_lt', 'block_number_gte', 'block_number_lte', 'block_number_in', 'block_number_not_in', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'gas_used', 'gas_used_not', 'gas_used_gt', 'gas_used_lt', 'gas_used_gte', 'gas_used_lte', 'gas_used_in', 'gas_used_not_in', 'gas_price', 'gas_price_not', 'gas_price_gt', 'gas_price_lt', 'gas_price_gte', 'gas_price_lte', 'gas_price_in', 'gas_price_not_in', 'mints_', 'burns_', 'swaps_', 'flashed_', 'collects_', '_change_block')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
    ...
    burns_ = sgqlc.types.Field(Burn_filter, graphql_name='burns_')
    swaps_ = sgqlc.types.Field(Swap_filter, graphql_name='swaps_')
    flashed_ = sgqlc.types.Field(Flash_filter, graphql_name='flashed_')
    collects_ = sgqlc.types.Field(Collect_filter, graphql_name='collects_')
    _change_block = sgqlc.types.Field(BlockChangedFilter, graphql_name='_change_block')
