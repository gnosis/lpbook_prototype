...
class Account_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'address', 'address_not', 'address_in', 'address_not_in', 'address_contains', 'address_not_contains')
...
class AddLiquidityEvent_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with', 'provider', 'provider_not', 'provider_gt', 'provider_lt', 'provider_gte', 'provider_lte', 'provider_in', 'provider_not_in', 'provider_contains', 'provider_not_contains', 'provider_starts_with', 'provider_not_starts_with', 'provider_ends_with', 'provider_not_ends_with', 'token_amounts', 'token_amounts_not', 'token_amounts_contains', 'token_amounts_not_contains', 'fees', 'fees_not', 'fees_contains', 'fees_not_contains', 'invariant', 'invariant_not', 'invariant_gt', 'invariant_lt', 'invariant_gte', 'invariant_lte', 'invariant_in', 'invariant_not_in', 'token_supply', 'token_supply_not', 'token_supply_gt', 'token_supply_lt', 'token_supply_gte', 'token_supply_lte', 'token_supply_in', 'token_supply_not_in', 'block', 'block_not', 'block_gt', 'block_lt', 'block_gte', 'block_lte', 'block_in', 'block_not_in', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'transaction', 'transaction_not', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class AdminFeeChangelog_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with', 'value', 'value_not', 'value_gt', 'value_lt', 'value_gte', 'value_lte', 'value_in', 'value_not_in', 'block', 'block_not', 'block_gt', 'block_lt', 'block_gte', 'block_lte', 'block_in', 'block_not_in', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'transaction', 'transaction_not', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class ContractVersion_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'contract', 'contract_not', 'contract_gt', 'contract_lt', 'contract_gte', 'contract_lte', 'contract_in', 'contract_not_in', 'contract_contains', 'contract_not_contains', 'contract_starts_with', 'contract_not_starts_with', 'contract_ends_with', 'contract_not_ends_with', 'address', 'address_not', 'address_in', 'address_not_in', 'address_contains', 'address_not_contains', 'version', 'version_not', 'version_gt', 'version_lt', 'version_gte', 'version_lte', 'version_in', 'version_not_in', 'added', 'added_not', 'added_gt', 'added_lt', 'added_gte', 'added_lte', 'added_in', 'added_not_in', 'added_at_block', 'added_at_block_not', 'added_at_block_gt', 'added_at_block_lt', 'added_at_block_gte', 'added_at_block_lte', 'added_at_block_in', 'added_at_block_not_in', 'added_at_transaction', 'added_at_transaction_not', 'added_at_transaction_in', 'added_at_transaction_not_in', 'added_at_transaction_contains', 'added_at_transaction_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class DailyVolume_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'volume', 'volume_not', 'volume_gt', 'volume_lt', 'volume_gte', 'volume_lte', 'volume_in', 'volume_not_in')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class Exchange_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with', 'buyer', 'buyer_not', 'buyer_gt', 'buyer_lt', 'buyer_gte', 'buyer_lte', 'buyer_in', 'buyer_not_in', 'buyer_contains', 'buyer_not_contains', 'buyer_starts_with', 'buyer_not_starts_with', 'buyer_ends_with', 'buyer_not_ends_with', 'receiver', 'receiver_not', 'receiver_gt', 'receiver_lt', 'receiver_gte', 'receiver_lte', 'receiver_in', 'receiver_not_in', 'receiver_contains', 'receiver_not_contains', 'receiver_starts_with', 'receiver_not_starts_with', 'receiver_ends_with', 'receiver_not_ends_with', 'token_sold', 'token_sold_not', 'token_sold_gt', 'token_sold_lt', 'token_sold_gte', 'token_sold_lte', 'token_sold_in', 'token_sold_not_in', 'token_sold_contains', 'token_sold_not_contains', 'token_sold_starts_with', 'token_sold_not_starts_with', 'token_sold_ends_with', 'token_sold_not_ends_with', 'token_bought', 'token_bought_not', 'token_bought_gt', 'token_bought_lt', 'token_bought_gte', 'token_bought_lte', 'token_bought_in', 'token_bought_not_in', 'token_bought_contains', 'token_bought_not_contains', 'token_bought_starts_with', 'token_bought_not_starts_with', 'token_bought_ends_with', 'token_bought_not_ends_with', 'amount_sold', 'amount_sold_not', 'amount_sold_gt', 'amount_sold_lt', 'amount_sold_gte', 'amount_sold_lte', 'amount_sold_in', 'amount_sold_not_in', 'amount_bought', 'amount_bought_not', 'amount_bought_gt', 'amount_bought_lt', 'amount_bought_gte', 'amount_bought_lte', 'amount_bought_in', 'amount_bought_not_in', 'block', 'block_not', 'block_gt', 'block_lt', 'block_gte', 'block_lte', 'block_in', 'block_not_in', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'transaction', 'transaction_not', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class GaugeDeposit_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'gauge', 'gauge_not', 'gauge_gt', 'gauge_lt', 'gauge_gte', 'gauge_lte', 'gauge_in', 'gauge_not_in', 'gauge_contains', 'gauge_not_contains', 'gauge_starts_with', 'gauge_not_starts_with', 'gauge_ends_with', 'gauge_not_ends_with', 'provider', 'provider_not', 'provider_gt', 'provider_lt', 'provider_gte', 'provider_lte', 'provider_in', 'provider_not_in', 'provider_contains', 'provider_not_contains', 'provider_starts_with', 'provider_not_starts_with', 'provider_ends_with', 'provider_not_ends_with', 'value', 'value_not', 'value_gt', 'value_lt', 'value_gte', 'value_lte', 'value_in', 'value_not_in')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class GaugeTotalWeight_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'time', 'time_not', 'time_gt', 'time_lt', 'time_gte', 'time_lte', 'time_in', 'time_not_in', 'weight', 'weight_not', 'weight_gt', 'weight_lt', 'weight_gte', 'weight_lte', 'weight_in', 'weight_not_in')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class GaugeTypeWeight_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'type', 'type_not', 'type_gt', 'type_lt', 'type_gte', 'type_lte', 'type_in', 'type_not_in', 'type_contains', 'type_not_contains', 'type_starts_with', 'type_not_starts_with', 'type_ends_with', 'type_not_ends_with', 'time', 'time_not', 'time_gt', 'time_lt', 'time_gte', 'time_lte', 'time_in', 'time_not_in', 'weight', 'weight_not', 'weight_gt', 'weight_lt', 'weight_gte', 'weight_lte', 'weight_in', 'weight_not_in')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class GaugeType_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'name', 'name_not', 'name_gt', 'name_lt', 'name_gte', 'name_lte', 'name_in', 'name_not_in', 'name_contains', 'name_not_contains', 'name_starts_with', 'name_not_starts_with', 'name_ends_with', 'name_not_ends_with', 'gauge_count', 'gauge_count_not', 'gauge_count_gt', 'gauge_count_lt', 'gauge_count_gte', 'gauge_count_lte', 'gauge_count_in', 'gauge_count_not_in')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class GaugeWeightVote_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'gauge', 'gauge_not', 'gauge_gt', 'gauge_lt', 'gauge_gte', 'gauge_lte', 'gauge_in', 'gauge_not_in', 'gauge_contains', 'gauge_not_contains', 'gauge_starts_with', 'gauge_not_starts_with', 'gauge_ends_with', 'gauge_not_ends_with', 'user', 'user_not', 'user_gt', 'user_lt', 'user_gte', 'user_lte', 'user_in', 'user_not_in', 'user_contains', 'user_not_contains', 'user_starts_with', 'user_not_starts_with', 'user_ends_with', 'user_not_ends_with', 'time', 'time_not', 'time_gt', 'time_lt', 'time_gte', 'time_lte', 'time_in', 'time_not_in', 'weight', 'weight_not', 'weight_gt', 'weight_lt', 'weight_gte', 'weight_lte', 'weight_in', 'weight_not_in')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class GaugeWeight_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'gauge', 'gauge_not', 'gauge_gt', 'gauge_lt', 'gauge_gte', 'gauge_lte', 'gauge_in', 'gauge_not_in', 'gauge_contains', 'gauge_not_contains', 'gauge_starts_with', 'gauge_not_starts_with', 'gauge_ends_with', 'gauge_not_ends_with', 'time', 'time_not', 'time_gt', 'time_lt', 'time_gte', 'time_lte', 'time_in', 'time_not_in', 'weight', 'weight_not', 'weight_gt', 'weight_lt', 'weight_gte', 'weight_lte', 'weight_in', 'weight_not_in')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class Gauge_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'address', 'address_not', 'address_in', 'address_not_in', 'address_contains', 'address_not_contains', 'type', 'type_not', 'type_gt', 'type_lt', 'type_gte', 'type_lte', 'type_in', 'type_not_in', 'type_contains', 'type_not_contains', 'type_starts_with', 'type_not_starts_with', 'type_ends_with', 'type_not_ends_with', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with', 'created', 'created_not', 'created_gt', 'created_lt', 'created_gte', 'created_lte', 'created_in', 'created_not_in', 'created_at_block', 'created_at_block_not', 'created_at_block_gt', 'created_at_block_lt', 'created_at_block_gte', 'created_at_block_lte', 'created_at_block_in', 'created_at_block_not_in', 'created_at_transaction', 'created_at_transaction_not', 'created_at_transaction_in', 'created_at_transaction_not_in', 'created_at_transaction_contains', 'created_at_transaction_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class LpToken_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'address', 'address_not', 'address_in', 'address_not_in', 'address_contains', 'address_not_contains', 'decimals', 'decimals_not', 'decimals_gt', 'decimals_lt', 'decimals_gte', 'decimals_lte', 'decimals_in', 'decimals_not_in', 'name', 'name_not', 'name_gt', 'name_lt', 'name_gte', 'name_lte', 'name_in', 'name_not_in', 'name_contains', 'name_not_contains', 'name_starts_with', 'name_not_starts_with', 'name_ends_with', 'name_not_ends_with', 'symbol', 'symbol_not', 'symbol_gt', 'symbol_lt', 'symbol_gte', 'symbol_lte', 'symbol_in', 'symbol_not_in', 'symbol_contains', 'symbol_not_contains', 'symbol_starts_with', 'symbol_not_starts_with', 'symbol_ends_with', 'symbol_not_ends_with', 'gauge', 'gauge_not', 'gauge_gt', 'gauge_lt', 'gauge_gte', 'gauge_lte', 'gauge_in', 'gauge_not_in', 'gauge_contains', 'gauge_not_contains', 'gauge_starts_with', 'gauge_not_starts_with', 'gauge_ends_with', 'gauge_not_ends_with', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class PoolEvent_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with', 'block', 'block_not', 'block_gt', 'block_lt', 'block_gte', 'block_lte', 'block_in', 'block_not_in', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'transaction', 'transaction_not', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_not_contains')
    pool = sgqlc.types.Field(String, graphql_name='pool')
    pool_not = sgqlc.types.Field(String, graphql_name='pool_not')
    pool_gt = sgqlc.types.Field(String, graphql_name='pool_gt')
    pool_lt = sgqlc.types.Field(String, graphql_name='pool_lt')
...
class ProposalVote_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'proposal', 'proposal_not', 'proposal_gt', 'proposal_lt', 'proposal_gte', 'proposal_lte', 'proposal_in', 'proposal_not_in', 'proposal_contains', 'proposal_not_contains', 'proposal_starts_with', 'proposal_not_starts_with', 'proposal_ends_with', 'proposal_not_ends_with', 'supports', 'supports_not', 'supports_in', 'supports_not_in', 'stake', 'stake_not', 'stake_gt', 'stake_lt', 'stake_gte', 'stake_lte', 'stake_in', 'stake_not_in', 'voter', 'voter_not', 'voter_gt', 'voter_lt', 'voter_gte', 'voter_lte', 'voter_in', 'voter_not_in', 'voter_contains', 'voter_not_contains', 'voter_starts_with', 'voter_not_starts_with', 'voter_ends_with', 'voter_not_ends_with', 'created', 'created_not', 'created_gt', 'created_lt', 'created_gte', 'created_lte', 'created_in', 'created_not_in', 'created_at_block', 'created_at_block_not', 'created_at_block_gt', 'created_at_block_lt', 'created_at_block_gte', 'created_at_block_lte', 'created_at_block_in', 'created_at_block_not_in', 'created_at_transaction', 'created_at_transaction_not', 'created_at_transaction_in', 'created_at_transaction_not_in', 'created_at_transaction_contains', 'created_at_transaction_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class Token_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'address', 'address_not', 'address_in', 'address_not_in', 'address_contains', 'address_not_contains', 'decimals', 'decimals_not', 'decimals_gt', 'decimals_lt', 'decimals_gte', 'decimals_lte', 'decimals_in', 'decimals_not_in', 'name', 'name_not', 'name_gt', 'name_lt', 'name_gte', 'name_lte', 'name_in', 'name_not_in', 'name_contains', 'name_not_contains', 'name_starts_with', 'name_not_starts_with', 'name_ends_with', 'name_not_ends_with', 'symbol', 'symbol_not', 'symbol_gt', 'symbol_lt', 'symbol_gte', 'symbol_lte', 'symbol_in', 'symbol_not_in', 'symbol_contains', 'symbol_not_contains', 'symbol_starts_with', 'symbol_not_starts_with', 'symbol_ends_with', 'symbol_not_ends_with', 'pools', 'pools_not', 'pools_contains', 'pools_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class TransferOwnershipEvent_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with', 'new_admin', 'new_admin_not', 'new_admin_in', 'new_admin_not_in', 'new_admin_contains', 'new_admin_not_contains', 'block', 'block_not', 'block_gt', 'block_lt', 'block_gte', 'block_lte', 'block_in', 'block_not_in', 'timestamp', 'timestamp_not', 'timestamp_gt', 'timestamp_lt', 'timestamp_gte', 'timestamp_lte', 'timestamp_in', 'timestamp_not_in', 'transaction', 'transaction_not', 'transaction_in', 'transaction_not_in', 'transaction_contains', 'transaction_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
...
class UnderlyingCoin_filter(sgqlc.types.Input):
    __schema__ = graphql_schema
    __field_names__ = ('id', 'id_not', 'id_gt', 'id_lt', 'id_gte', 'id_lte', 'id_in', 'id_not_in', 'index', 'index_not', 'index_gt', 'index_lt', 'index_gte', 'index_lte', 'index_in', 'index_not_in', 'pool', 'pool_not', 'pool_gt', 'pool_lt', 'pool_gte', 'pool_lte', 'pool_in', 'pool_not_in', 'pool_contains', 'pool_not_contains', 'pool_starts_with', 'pool_not_starts_with', 'pool_ends_with', 'pool_not_ends_with', 'token', 'token_not', 'token_gt', 'token_lt', 'token_gte', 'token_lte', 'token_in', 'token_not_in', 'token_contains', 'token_not_contains', 'token_starts_with', 'token_not_starts_with', 'token_ends_with', 'token_not_ends_with', 'coin', 'coin_not', 'coin_gt', 'coin_lt', 'coin_gte', 'coin_lte', 'coin_in', 'coin_not_in', 'coin_contains', 'coin_not_contains', 'coin_starts_with', 'coin_not_starts_with', 'coin_ends_with', 'coin_not_ends_with', 'balance', 'balance_not', 'balance_gt', 'balance_lt', 'balance_gte', 'balance_lte', 'balance_in', 'balance_not_in', 'updated', 'updated_not', 'updated_gt', 'updated_lt', 'updated_gte', 'updated_lte', 'updated_in', 'updated_not_in', 'updated_at_block', 'updated_at_block_not', 'updated_at_block_gt', 'updated_at_block_lt', 'updated_at_block_gte', 'updated_at_block_lte', 'updated_at_block_in', 'updated_at_block_not_in', 'updated_at_transaction', 'updated_at_transaction_not', 'updated_at_transaction_in', 'updated_at_transaction_not_in', 'updated_at_transaction_contains', 'updated_at_transaction_not_contains')
    id = sgqlc.types.Field(ID, graphql_name='id')
    id_not = sgqlc.types.Field(ID, graphql_name='id_not')
    id_gt = sgqlc.types.Field(ID, graphql_name='id_gt')
    id_lt = sgqlc.types.Field(ID, graphql_name='id_lt')
